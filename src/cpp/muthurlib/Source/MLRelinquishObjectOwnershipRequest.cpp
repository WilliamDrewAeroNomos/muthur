//------------------------------------------------------------------------------
/*! \file	MLRelinquishObjectOwnershipRequest.cpp
//
//  Contains the implementation of the CMLRelinquishObjectOwnershipRequest class
//
//	<table>
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLRelinquishObjectOwnershipRequest::CMLRelinquishObjectOwnershipRequest() 
			     :CMLRequestParams()
{	
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLRelinquishObjectOwnershipRequest::CMLRelinquishObjectOwnershipRequest(const CMLRelinquishObjectOwnershipRequest& rSource)
{
	Copy(rSource);
}
...
//!	Returns:	None
//------------------------------------------------------------------------------
void CMLRelinquishObjectOwnershipRequest::Copy(const CMLRelinquishObjectOwnershipRequest& rSource)
{
...
//------------------------------------------------------------------------------
char* CMLRelinquishObjectOwnershipRequest::GetDataObjectUUID()
{
...
//!	Returns:	this object
//------------------------------------------------------------------------------
const CMLRelinquishObjectOwnershipRequest& CMLRelinquishObjectOwnershipRequest::operator = (const CMLRelinquishObjectOwnershipRequest& rSource)
{
	Copy(rSource);
	return *this;
}
...
//!	Returns:	None
//------------------------------------------------------------------------------
void CMLRelinquishObjectOwnershipRequest::SetDataObjectUUID(char* pszUUID)
{
	if(pszUUID != NULL)
...
//------------------------------------------------------------------------------
CMLPropMember* CMLRelinquishObjectOwnershipRequest::GetXmlBlock(EMLXMLBlock eXmlBlock)
{
...
//------------------------------------------------------------------------------
bool CMLRelinquishObjectOwnershipRequest::SetXmlValue(EMLXMLBlock eXmlBlock, CMLPropMember* pMLPropMember)
{
	...
	_theReqReporter.Debug("CMLRelinquishObjectOwnershipRequest", "SetXmlValue", "pMLPropMember->GetName():%s",
