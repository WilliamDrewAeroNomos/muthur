 ...
 * 
 */
public class RelinquishObjectOwnershipRequest extends AbstractEvent {
	 ...
	 * 
	 */
	public RelinquishObjectOwnershipRequest() {
		super();
	}
	...
	public String getEventName() {
		return EventTypeEnum.RelinquishObjectOwnershipRequest.toString();
	}
	...
	public String getHandler() {
		return EventHandlerName.relinquishObjectOwnershipRequestHandler.toString();
	}
	...
	public EventTypeEnum getEventType() {
		return EventTypeEnum.RelinquishObjectOwnershipRequest;
	}
	...
	public boolean equals(Object obj) {
		...
		RelinquishObjectOwnershipRequest other =
				(RelinquishObjectOwnershipRequest) obj;
	...
	public String toString() {
		return "RelinquishObjectOwnershipRequest [dataObjectUUID=" + dataObjectUUID
