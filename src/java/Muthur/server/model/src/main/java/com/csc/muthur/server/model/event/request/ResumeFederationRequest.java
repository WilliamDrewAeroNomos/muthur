 ...
 * 
 */
public class ResumeFederationRequest extends AbstractEvent {

	/**
	 * 
	 */
	public ResumeFederationRequest() {
		super();
	}
	...
	public String getEventName() {
		return EventTypeEnum.ResumeFederationRequest.getDescription();
	}
	...
	public EventTypeEnum getEventType() {
		return EventTypeEnum.ResumeFederationRequest;
	}
	...
	public String getHandler() {
		return EventHandlerName.resumeFederationRequestHandler.toString();
	}
}
