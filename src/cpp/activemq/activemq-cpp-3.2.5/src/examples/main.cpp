...
public:
    ...
    virtual void run() {
        ...
        try {
            ...
            if( useTopic ) {
                destination = session->createTopic( "MUTHUR.EVENT.QUEUE" );
            } else {
                destination = session->createQueue( "MUTHUR.EVENT.QUEUE" );
            }
...
int main(int argc AMQCPP_UNUSED, char* argv[] AMQCPP_UNUSED) {
    ...
    //
    std::string brokerURI =
        "failover:(tcp://192.168.1.75:61616"
//        "?wireFormat=openwire"
...
//        "&wireFormat.tightEncodingEnabled=true"
	...
	std::cout << "Wait for consumer ready\nPress any key to continue...\n\n"; getchar();
   ...
   // Wait for the consumer to indicate that its ready to go.
	...
	std::cout << "Wait for threads to complete\nPress any key to continue...\n\n"; getchar();
