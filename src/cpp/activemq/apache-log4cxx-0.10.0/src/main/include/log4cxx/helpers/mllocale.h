...
namespace log4cxx
{
        namespace helpers
        {
                class LOG4CXX_EXPORT CMLLocale
                {
                public:
                        CMLLocale(const LogString& language);
                        CMLLocale(const LogString& language, const LogString& country);
                        CMLLocale(const LogString& language, const LogString& country,
                ...
                protected:
                        CMLLocale(const CMLLocale&);
                        CMLLocale& operator=(const CMLLocale&);
