 ...
 * 
 */
public class DeleteObjectResponse extends AbstractEvent {
	...
	public String getEventName() {
		return EventTypeEnum.DeleteObjectResponse.toString();
	}
	...
	public EventTypeEnum getEventType() {
		return EventTypeEnum.DeleteObjectResponse;
	}
	...
	public String toString() {
		return "DeleteObjectResponse [dataObjectUUID=" + dataObjectUUID + "]";
	}
