//------------------------------------------------------------------------------
/*! \file	MLUpdateObjectResponse.cpp
//
//  Contains the implementation of the CMLUpdateObjectResponse class
//
//	<table>
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLUpdateObjectResponse::CMLUpdateObjectResponse() : CMLEvent()
{
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLUpdateObjectResponse::CMLUpdateObjectResponse(const CMLUpdateObjectResponse& rSource)
{
	Copy(rSource);
}
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLUpdateObjectResponse::~CMLUpdateObjectResponse()
{
}
...
//!	Returns:	None
//------------------------------------------------------------------------------
void CMLUpdateObjectResponse::Copy(const CMLUpdateObjectResponse& rSource)
{
...
//!	Returns:	this object
//------------------------------------------------------------------------------
const CMLUpdateObjectResponse& CMLUpdateObjectResponse::operator = (const CMLUpdateObjectResponse& 
																	rSource)
{
	Copy(rSource);
	return *this;
...
//------------------------------------------------------------------------------
char* CMLUpdateObjectResponse::GetDataObjectUUID()
{
...
//!	Returns:	None
//------------------------------------------------------------------------------
void CMLUpdateObjectResponse::SetDataObjectUUID(char* pszUUID)
{
	if(pszUUID != NULL)
...
//------------------------------------------------------------------------------
CMLPropMember* CMLUpdateObjectResponse::GetXmlBlock(EMLXMLBlock eXmlBlock)
{
...
//------------------------------------------------------------------------------
bool CMLUpdateObjectResponse::SetXmlValue(EMLXMLBlock eXmlBlock, CMLPropMember* pMLPropMember)
{
