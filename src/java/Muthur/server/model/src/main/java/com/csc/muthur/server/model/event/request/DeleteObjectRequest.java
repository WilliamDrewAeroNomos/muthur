 ...
 * 
 */
public class DeleteObjectRequest extends AbstractEvent {
	...
	public String getEventName() {
		return EventTypeEnum.DeleteObjectRequest.toString();
	}
	...
	public String getHandler() {
		return EventHandlerName.deleteObjectRequestHandler.toString();
	}
	...
	public EventTypeEnum getEventType() {
		return EventTypeEnum.DeleteObjectRequest;
	}
	...
	public String toString() {
		return "DeleteObjectRequest [dataObjectUUID=" + dataObjectUUID
