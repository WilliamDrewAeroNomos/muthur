 ...
 * 
 */
public class CreateObjectRequest extends AbstractEvent {
	...
	public String getEventName() {
		return EventTypeEnum.CreateObjectRequest.toString();
	}
	...
	public String getHandler() {
		return EventHandlerName.createObjectRequestHandler.toString();
	}

	@Override
	public EventTypeEnum getEventType() {
		return EventTypeEnum.CreateObjectRequest;
	}
	...
	public String toString() {
		return "CreateObjectRequest [dataObject=" + dataObject + ", dataType="
