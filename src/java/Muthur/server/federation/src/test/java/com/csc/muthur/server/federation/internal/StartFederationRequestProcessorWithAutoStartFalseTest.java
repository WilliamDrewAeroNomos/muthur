 ...
 * @version $Revision$
 */
public class StartFederationRequestProcessorWithAutoStartFalseTest extends
	...
	public void runAllTests() {
		...
		baseFederationRequestProcessorWithAutoStartFalse();
	 ...
	 * 
	 */
	public void baseFederationRequestProcessorWithAutoStartFalse() {
		...
		// need to call the start here cause the autoStart is true
		...
		// the semaphore will be released by messages received in the
		// FederationTimeManagementEventHandler.onMessage()
		...
		// terminate federation execution controller
		try {
