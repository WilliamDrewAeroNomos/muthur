//------------------------------------------------------------------------------
/*! \file	MLCreateObjectParams.cpp
//
//  Contains the implementation of the CMLCreateObjectParams class
//
//	<table>
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLCreateObjectParams::CMLCreateObjectParams(CMLDataObject* pDataObject) 
			     :CMLRequestParams()
{
	m_pDataObject = NULL;
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLCreateObjectParams::CMLCreateObjectParams(const CMLCreateObjectParams& rSource)
{
	Copy(rSource);
}
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLCreateObjectParams::~CMLCreateObjectParams()
{
}
...
//!	Returns:	None
//------------------------------------------------------------------------------
void CMLCreateObjectParams::Copy(const CMLCreateObjectParams& rSource)
{
...
//------------------------------------------------------------------------------
CMLDataObject* CMLCreateObjectParams::GetDataObject()
{
...
//!	Returns:	this object
//------------------------------------------------------------------------------
const CMLCreateObjectParams& CMLCreateObjectParams::operator = (const CMLCreateObjectParams& rSource)
{
	Copy(rSource);
	return *this;
}
...
//!	Returns:	None
//------------------------------------------------------------------------------
void CMLCreateObjectParams::SetDataObject(CMLDataObject* pDataObject)
{
...
//------------------------------------------------------------------------------
CMLPropMember* CMLCreateObjectParams::GetXmlBlock(EMLXMLBlock eXmlBlock)
{
...
//------------------------------------------------------------------------------
bool CMLCreateObjectParams::SetXmlValue(EMLXMLBlock eXmlBlock, CMLPropMember* pMLPropMember)
{
	bool				bSuccessful = false;
	CMLPropMember*		pChild = NULL;
	CMLPropMember*		pCopypMLPropMember = pMLPropMember ? new CMLPropMember(*pMLPropMember) : NULL;

	_theReqReporter.Debug("CMLCreateObjectParams", "SetXmlValue", "pMLPropMember->GetName():%s", pMLPropMember->GetName());
	...
	case ML_XML_BLOCK_DATA:		
		...
		if(pCopypMLPropMember)
		{
			...
			{
				_theReqReporter.Debug("CMLCreateObjectParams", "SetXmlValue", "1 pCopypMLPropMember->GetName():%s", pCopypMLPropMember->GetName());
				...
				else
				{
					...
					_theReqReporter.Debug("CMLCreateObjectParams", "SetXmlValue", "2 pCopypMLPropMember->GetName():%s", pCopypMLPropMember->GetName());
					continue;
				}
		...
		if(lstrcmpi("dataObjectAsXML", pMLPropMember->GetName()) == 0)
		{
			...
			if(pChild)
			{
				_theReqReporter.Debug("CMLCreateObjectParams", "SetXmlValue", "pChild->GetName():%s; pChild->GetValue():%s",
					pChild->GetName(), pChild->GetValue());
			}
			else
			{
				_theReqReporter.Debug("CMLCreateObjectParams", "SetXmlValue", "pChild is NULL!!");
			}
			...
			if(m_pDataObject)
				...
				_theReqReporter.Debug("CMLCreateObjectParams", "SetXmlValue", "m_pDataObject is NULL!!");
		}
