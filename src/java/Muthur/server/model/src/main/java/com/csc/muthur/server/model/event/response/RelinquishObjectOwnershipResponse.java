 ...
 * 
 */
public class RelinquishObjectOwnershipResponse extends AbstractEvent {
	 ...
	 * 
	 */
	public RelinquishObjectOwnershipResponse() {
		super();
	}
	...
	public String getEventName() {
		return EventTypeEnum.RelinquishObjectOwnershipResponse.toString();
	}
	...
	public String getHandler() {
		return EventHandlerName.relinquishObjectOwnershipResponseHandler.toString();
	}
	...
	public EventTypeEnum getEventType() {
		return EventTypeEnum.RelinquishObjectOwnershipResponse;
	}
	...
	public boolean equals(Object obj) {
		...
		RelinquishObjectOwnershipResponse other =
				(RelinquishObjectOwnershipResponse) obj;
	...
	public String toString() {
		return "RelinquishObjectOwnershipResponse [dataObjectUUID="
				+ dataObjectUUID + "]";
	}
