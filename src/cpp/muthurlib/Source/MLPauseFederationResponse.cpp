//------------------------------------------------------------------------------
/*! \file	MLPauseFederationResponse.cpp
//
//  Contains the implementation of the CMLPauseFederationResponse class
//
//	<table>
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLPauseFederationResponse::CMLPauseFederationResponse() : CMLEvent()
{
	m_bPauseFedResponseAck = false;
}
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLPauseFederationResponse::CMLPauseFederationResponse(const CMLPauseFederationResponse& rSource)
{
	Copy(rSource);
}
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLPauseFederationResponse::~CMLPauseFederationResponse()
{
}
...
//!	Returns:	None
//------------------------------------------------------------------------------
void CMLPauseFederationResponse::Copy(const CMLPauseFederationResponse& rSource)
{
	CMLEvent::Copy(rSource); // base class processing first
	m_bPauseFedResponseAck = rSource.m_bPauseFedResponseAck;
}
...
//!	Returns:	this object
//------------------------------------------------------------------------------
const CMLPauseFederationResponse& CMLPauseFederationResponse::operator = (const CMLPauseFederationResponse& rSource)
{
	Copy(rSource);
	return *this;
}
...
//------------------------------------------------------------------------------
//!	Summary:	Called to retrieve pauseFedResponseAck
//!
//!	Parameters:	None
//!
//!	Returns:	pauseFedResponseAck
//------------------------------------------------------------------------------
bool CMLPauseFederationResponse::GetPauseFedResponseAck()
{
	return m_bPauseFedResponseAck;
}
//------------------------------------------------------------------------------
//!	Summary:	Called to set pauseFedResponseAck
//!
//!	Parameters:	None
//!
//!	Returns:	pauseFedResponseAck
//------------------------------------------------------------------------------
void CMLPauseFederationResponse::SetPauseFedResponseAck(bool b)
{
	m_bPauseFedResponseAck = b;
}
...
//------------------------------------------------------------------------------
CMLPropMember* CMLPauseFederationResponse::GetXmlBlock(EMLXMLBlock eXmlBlock)
{
	...
	if((pXmlBlock = CMLEvent::GetXmlBlock(eXmlBlock)) != NULL)
	{
		...
		case ML_XML_BLOCK_DATA:
			pXmlClasses = new CMLPropMember("pauseFederationResponseAck", m_bPauseFedResponseAck);
			pXmlBlock->AddChild(pXmlClasses);
...
//------------------------------------------------------------------------------
bool CMLPauseFederationResponse::SetXmlValue(EMLXMLBlock eXmlBlock, CMLPropMember* pMLPropMember)
{
	...
	case ML_XML_BLOCK_CONTROL:
		...
		break;
	case ML_XML_BLOCK_DATA:
		if(lstrcmpi(pMLPropMember->GetName(), "pauseFederationResponseAck") == 0)
		{
			m_bPauseFedResponseAck = pMLPropMember->AsBool();			
		}
