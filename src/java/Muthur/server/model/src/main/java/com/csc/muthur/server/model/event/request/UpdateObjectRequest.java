 ...
 * 
 */
public class UpdateObjectRequest extends AbstractEvent {
	...
	public void initialization(final String objectAsXML) throws MuthurException {
		...
		if (dataObject == null) {
			throw new MuthurException(
					"DataObjectFactory.getDataObject() returned a null object for ["
							+ getDataType() + "]");
		}
	...
	public String getEventName() {
		return EventTypeEnum.UpdateObjectRequest.toString();
	}
	...
	public String getHandler() {
		return EventHandlerName.updateObjectRequestHandler.toString();
	}
	...
	public EventTypeEnum getEventType() {
		return EventTypeEnum.UpdateObjectRequest;
	}
	...
	public String toString() {
		return "UpdateObjectRequest [dataObject=" + dataObject + ", dataType="
				+ dataType + ", federationExecutionModelHandle="
