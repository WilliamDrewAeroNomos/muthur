 ...
 * 
 */
public class TransferObjectOwnershipRequest extends AbstractEvent {

	/**
	 * dataBlock attributes
	 */
	private String dataObjectUUID; // id of the object requested to transfer

	/**
	 * 
	 */
	public TransferObjectOwnershipRequest() {
		super();
	}
	...
	public String getEventName() {
		return EventTypeEnum.TransferObjectOwnershipRequest.toString();
	}
	...
	public String getHandler() {
		return EventHandlerName.transferObjectOwnershipRequestHandler.toString();
	}

	@Override
	public EventTypeEnum getEventType() {
		return EventTypeEnum.TransferObjectOwnershipRequest;
	}
	...
	public boolean equals(Object obj) {
		...
		TransferObjectOwnershipRequest other = (TransferObjectOwnershipRequest) obj;
	...
	public String toString() {
		return "TransferObjectOwnershipRequest [dataObjectUUID=" + dataObjectUUID
				+ ", federationExecutionModelHandle=" + getFederationExecutionModelHandle()
				+ super.toString() + "]";
	}
}
