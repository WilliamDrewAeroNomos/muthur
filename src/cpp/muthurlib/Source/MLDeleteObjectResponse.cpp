//------------------------------------------------------------------------------
/*! \file	MLDeleteObjectResponse.cpp
//
//  Contains the implementation of the CMLDeleteObjectResponse class
//
//	<table>
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLDeleteObjectResponse::CMLDeleteObjectResponse() : CMLEvent()
{
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLDeleteObjectResponse::CMLDeleteObjectResponse(const CMLDeleteObjectResponse& rSource)
{
	Copy(rSource);
}
...
//!	Returns:	None
//------------------------------------------------------------------------------
CMLDeleteObjectResponse::~CMLDeleteObjectResponse()
{
}
...
//!	Returns:	None
//------------------------------------------------------------------------------
void CMLDeleteObjectResponse::Copy(const CMLDeleteObjectResponse& rSource)
{
...
//!	Returns:	this object
//------------------------------------------------------------------------------
const CMLDeleteObjectResponse& CMLDeleteObjectResponse::operator = (const CMLDeleteObjectResponse& 
																	rSource)
{
	Copy(rSource);
	return *this;
...
//------------------------------------------------------------------------------
char* CMLDeleteObjectResponse::GetDataObjectUUID()
{
...
//!	Returns:	None
//------------------------------------------------------------------------------
void CMLDeleteObjectResponse::SetDataObjectUUID(char* pszUUID)
{
	if(pszUUID != NULL)
...
//------------------------------------------------------------------------------
CMLPropMember* CMLDeleteObjectResponse::GetXmlBlock(EMLXMLBlock eXmlBlock)
{
...
//------------------------------------------------------------------------------
bool CMLDeleteObjectResponse::SetXmlValue(EMLXMLBlock eXmlBlock, CMLPropMember* pMLPropMember)
{
