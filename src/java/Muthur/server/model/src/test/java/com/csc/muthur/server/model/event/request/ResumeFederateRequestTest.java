 ...
 * 
 */
public class ResumeFederateRequestTest extends AbstractModelTest {
	 ...
	 */
	@Test
	public void testResumeFederateRequest() {

		ResumeFederateRequest req = new ResumeFederateRequest();
		...
		ResumeFederateRequest reqFromXML = new ResumeFederateRequest();
